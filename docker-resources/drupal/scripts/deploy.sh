...
if [ ! -f /var/www/html/core/authorize.php ]; then
  echo 'Copying drupal core directory to the shared volume.'
  cp -r /var/www/html-tmp-core/* /var/www/html/core
else
  echo 'Drupal core directory already exists the shared volume.'
fi
